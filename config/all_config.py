...
class AllConfig(Config):
    ...
    def parse_args(self):
        ...
        # parser.add_argument('--it', type=bool, action='store_true', default=False, help="whether to use it")
        ...
        parser.add_argument('--num_heads_iv', type=int, default=4, help='Number of parallel heads in multi-headed attention iv')
        ...
        parser.add_argument('--text_embedding_path', type=str, default='/share/home/xscow_jnugql/liuc/text-video-retrieval/weight/clip-vit-base-patch32')
        parser.add_argument('--vision_embedding_path', type=str, default='/share/home/xscow_jnugql/liuc/text-video-retrieval/weight/clip-vit-base-patch32')
        parser.add_argument('--train_data_path', type=str, default='/share/home/xscow_jnugql/liuc/text-video-retrieval/data/dataset/train_biology_all_f_msr.json')
        parser.add_argument('--test_data_path', type=str, default='/share/home/xscow_jnugql/liuc/text-video-retrieval/data/dataset/val_biology_all_f_msr.json')
        parser.add_argument('--select_layer', type=int, default=5, help='select the layer of CLIP to extract the feature')

        parser.add_argument('--local_rank', type=int, default=-1, help='local rank for DistributedDataParallel')
        parser.add_argument('--world_size', type=int, default=1, help='world size for DistributedDataParallel')
        parser.add_argument('--rank', type=int, default=0, help='rank for DistributedDataParallel')
